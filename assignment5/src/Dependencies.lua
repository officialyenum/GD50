...
gTextures = {
    ...
    ['player-pot-walk'] = love.graphics.newImage('graphics/character_pot_walk.png'),
    ['player-pot-carry'] = love.graphics.newImage('graphics/character_pot_lift.png')
}
...
gFrames = {
    ...
    ['player-pot-walk'] = GenerateQuads(gTextures['player-pot-walk'], 16, 32),
    ['player-pot-carry'] = GenerateQuads(gTextures['player-pot-carry'], 16, 32)
}
